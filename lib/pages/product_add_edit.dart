        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: FormHelper.inputFieldWidget(
              ...
              (onValidateVal) {
                if (onValidateVal.isEmpty) {
                  return 'prix can\'t be empty.';
                }

                return null;
              },
              (onSavedVal) => {
                productModel!.prix = int.parse(onSavedVal),
              },
              initialValue: productModel!.prix == null
                  ? ""
                  : productModel!.prix.toString(),
              obscureText: false,
              borderFocusColor: Colors.black,
              borderColor: Colors.black,
              textColor: Colors.black,
